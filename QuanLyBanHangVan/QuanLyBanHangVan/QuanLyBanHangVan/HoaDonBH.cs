    ...
    public partial class HoaDonBH : Form
    {
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            ...
            if (traloi == DialogResult.OK)
                ...
                {
                    ketnoi.dataOpen();
                    string sqlquery = @"DELETE from HoaDonBH where SoHD ='" + txtmancc.Text.Trim() + "'";
                    SqlCommand cmd = new SqlCommand(sqlquery, ketnoi.conn);
                    cmd.ExecuteNonQuery();
                    dataGridViewX1.DataSource = ketnoi.hienthi(@"Select * from HoaDonBH");
                    ketnoi.dataClose();
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            {
                ketnoi.dataOpen();
                string sqlquery = @"INSERT INTO HoaDonBH VALUES(N'" + txtmancc.Text.Trim() + "',N'" + dateTimePicker1.Text + "',N'" + cbmancc.SelectedValue + "','" + cbmanv.SelectedValue + "',N'" + txtdiengia.Text + "')";
                SqlCommand cmd = new SqlCommand(sqlquery, ketnoi.conn);
                cmd.ExecuteNonQuery();
                dataGridViewX1.DataSource = ketnoi.hienthi(@"Select*from HoaDonBH");
                ketnoi.dataClose();
        ...
        private void buttonX3_Click(object sender, EventArgs e)
        {
            ...
            {
                ketnoi.dataOpen();
                string sqlquery = @"UPDATE HoaDonBH SET NgayBan=N'" + dateTimePicker1.Text + "',MaK=N'" + cbmancc.SelectedValue + "',MaNV='" + cbmanv.SelectedValue + "',DienGiai=N'" + txtdiengia.Text + "'where SoHD='" + txtmancc.Text.Trim() + "'";
                SqlCommand cmd = new SqlCommand(sqlquery, ketnoi.conn);
                cmd.ExecuteNonQuery();
                dataGridViewX1.DataSource = ketnoi.hienthi("select * from HoaDonBH");
                ketnoi.dataClose();
